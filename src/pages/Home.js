...
const Home = () => {
  return (
    <>
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p>From $399 to $199/mo for 24 mo.</p>
              </div>
            </div>
          </div>
          <div className="col-3">
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark"> From $699.00 or $111.62/mo.
                  for 12 mo.</p>
              </div>
            </div>
          </div>
      ...
      <Container class1="marque-wrapper py-5 home-wrapper py-5">
        <div className="row">
          <div className="col-12">
