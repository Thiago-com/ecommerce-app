          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:
                <a className="text-white" href=" 4366 5222-(808)">+91 13365899</a>
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="menu-bottom d-flex align-items-center gap-30">
                <div>
                  <div className="dropdown">
                    <button class="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15 d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                      <img src="images/menu.svg"></img><span className="me-5 d-inline-block">Shop Categories</span>
                    </button>
                ...
                <div className="menu-links">
                  <div className="d-flex align-items-center gap-15">
                    ...
                    <NavLink className="text-white" to="/news">Blogs</NavLink>
